...
const parser = new XMLParser({
    ...
    attributeNamePrefix: '',
    textNodeName: '#text',
    isArray: (name, jpath) => ARRAY_ELEMENTS.includes(name) ||
    ...
    for (const [key, value] of Object.entries(processed)) {
        ...
        if (key === 'bom') {
            ...
            Object.assign(result, {
                ...
                ...Object.fromEntries(Object.entries(bomData).filter(([k]) => k !== 'xmlns' && k !== 'version')),
            });
        }
 ...
 */
export function xmlStringToJSON(xml) {
    const parsed = parser.parse(xml);
    return transform(parsed);
}
//# sourceMappingURL=cdx-xml-to-json.mjs.map