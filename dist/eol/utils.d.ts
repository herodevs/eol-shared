...
import type { ComponentMetadata, ComponentStatus } from '../types/eol-scan.js';
...
export declare function deriveComponentStatus(metadata: ComponentMetadata | null): ComponentStatus;
