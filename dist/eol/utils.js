 ...
 */
export function canonicalizePurl(purl, onUncanonicalized) {
    let parsed;
    try {
    ...
    try {
        ...
        return new PackageURL(type, namespace ?? undefined, name, parsed.version ?? undefined, parsed.qualifiers ?? undefined, parsed.subpath ?? undefined).toString();
    }
    catch (error) {
