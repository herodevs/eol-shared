...
function resolveMetadataComponentName(spdxDocumentName, rootComponentName) {
...
export function spdxToCdxBom(spdx) {
    ...
    const metadataName = resolveMetadataComponentName(spdx.name, rootComponent?.name ?? null);
...
//# sourceMappingURL=spdx-to-cdx.js.map