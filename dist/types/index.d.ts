...
export type ExternalReference = CDX.Serialize.JSON.Types.Normalized.ExternalReference;
export type { SPDX23 };
export type SupportedBom = CdxBom | SPDX23;
export declare const ComponentScope: typeof CDX.Enums.ComponentScope;
